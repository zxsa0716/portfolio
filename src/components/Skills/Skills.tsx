...
// ── Cluster row ───────────────────────────────────────────────────────────
function ClusterRow({ cluster }: { cluster: SkillCluster }) {
  return (
    <motion.div
      variants={fadeInUp}
      ...
      <div className="max-w-5xl mx-auto px-6">
        ...
        >
          ...
          <p className="text-sm" style={{ color: "#475569" }}>
            태그 밝기로 숙련도를 표현합니다 —&nbsp;
            <span style={{ color: "rgba(255,255,255,0.85)" }}>전문</span>
            &nbsp;/&nbsp;
            <span style={{ color: "rgba(255,255,255,0.55)" }}>숙련</span>
            &nbsp;/&nbsp;
            <span style={{ color: "rgba(255,255,255,0.32)" }}>기본</span>
          </p>
        </motion.div>
                ...
                {researchProjects.map((rp, i) => (
                  ...
                  >
                    <td className="px-6 py-4 text-sm leading-snug">
                      <span style={{ color: "#CBD5E1" }}>{rp.title}</span>
                      {rp.code !== "—" && (
                        <span className="block mt-0.5 font-mono text-[10px]" style={{ color: "#334155" }}>
                          {rp.code}
                        </span>
                      )}
                    </td>
