...
![같은 지역들을 node2vec 방식으로 임베딩한 결과를 2차원으로 눌러 그린 그림입니다. 점 하나가 산촌 한 곳이고, 가까이 붙은 점들은 조건이 비슷한 지역입니다. 지역 간 연결 구조를 학습에 반영했더니 군집이 뚜렷하게 갈라졌습니다. 이 군집 안에서 성공 사례가 있는 지역을 함께 보여주는 것이 추천의 원리입니다.](figures/tsne_node2vec.png)
